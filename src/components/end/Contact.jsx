...
import EarthCanvas from '../animation/Earth'
import SectionWrap from '../navigation/SectionWrap'
import { slideIn } from "../js/motion"
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send('service_nzkij4w','template_ci3dl6s',
        {
          from_name: form.name,
          to_name: "Ekoudi Akam",
          from_email: form.email,
          to_email: "donaldakam4@gmail.com",
  ...
  return (
    ...
    >
      <motion.div
        ...
        className='flex-[0.75] bg-red-100 p-8 rounded-2xl'
      >
